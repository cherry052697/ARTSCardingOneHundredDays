...
public class ObjectUtils {
     ...
     *
     * @param timeFormatStr
     *            格式化时间字符串默认<strong>2017-12-09 10:21</strong>
     * @param obj
     *            对象
     * @param excludeFields
     *            排除的属性
     ...
     * @throws IllegalAccessException
     */
    public static Map<String, String> objectToMapString(String timeFormatStr, Object obj,
     ...
     * @throws IllegalAccessException
     */
    private static Map<String, String> objectTransfer(String timeFormatStr, Object obj,
            Map<String, String> map, List<String> excludeFields) throws IllegalAccessException {
